<x-app-layout>
	...
	<x-slot name="title">Buat Penggalangan</x-slot>
	...
	<form action="{{ route('admin.campaign.store') }}" method="post" enctype="multipart/form-data">
		...
		<div class="row">
			<div class="col-md-8">
				<input type="text" class="form-control mb-3" name="title" placeholder="Masukkan judul" value="{{ old('title') }}">
              ...
              <i class="fas fa-minus"></i>
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="exampleInputFile" name="thumbnail" value="{{ old('thumbnail') }}">
